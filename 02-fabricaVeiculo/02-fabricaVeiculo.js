...
class Aplicacao {
  static criarVeiculos() {
    const carro1 = new Carro("SUV", "Hyundai", "Branco", 4, 150);
    const carro2 = new Carro("Esportivo", "lamborguini", "Azul Royal", 4, 700);
    const moto1 = new Moto("Street", "Ford", "Preto", 2, 250);
